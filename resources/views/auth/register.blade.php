    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                    <label for="password" class="col-md-5 col-form-label text-md-left">住所<span class="ml-1 samazon-require-input-label"><span class="samazon-require-input-lbel-text">必須</span></span></label>

                    <div class="col-md-7">
                        <input type="text" class="form-control @error('address') is-invalid @enderror samazon-login-input" name="address" required placeholder="東京都渋谷区道坂２丁目１１−１">
                  </div>
                </div>
